            ...
            <div className="grid justify-center sm:flex justify-between items-start gap-2">
              ...
              >
                <img
                  ...
                  height={300}
                  width={300}
                  className="object-contain shadow-lg text-center mx-auto border-1 border-black"
                />
              </motion.div>
              <motion.div className="sm:w-2/3 sm:ms-2 sm:mt-0 flex flex-col gap-1 sm:gap-2 text-center justify-around items-start">
                <motion.h3
                  ...
                  initial={{ opacity: 0, x: 50 }}
                  transition={{ duration: 1 }}
                  className="text-base sm:text-lg font-medium font-semibold text-gray-900 py-1 sm:py-2"
                >
                ...
                <motion.h4
                  ...
                  className="text-base sm:text-md text-gray-700 font-normal"
                >
                ...
                <motion.h4
                  ...
                  transition={{ duration: 2 }}
                  className="text-base sm:text-md text-gray-600 mt-2 font-normal"
                >
